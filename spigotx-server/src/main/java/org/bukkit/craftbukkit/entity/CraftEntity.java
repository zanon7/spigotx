...
public abstract class CraftEntity implements org.bukkit.entity.Entity {
    ...
    // private EntityDamageEvent lastDamageEvent; // this is almost never used and only leads to memory leaks
    ...
    public void setLastDamageCause(EntityDamageEvent event) {
        //lastDamageEvent = event; // this is never used and only leads to memory leaks when unloading worlds
    }
